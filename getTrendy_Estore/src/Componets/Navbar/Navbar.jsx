...
const Navigation = () => {
  ...
  return (
    <div>
      <Navbar expand="lg" fixed="top" className="navigation text-white bg-navbar">
        <Container>
          <Navbar.Brand href="/">
            ...
            <div className="cart-menu">
              {isAuthenticated ? (
                <Nav.Link href="#" onClick={handleCartClick}>
                  <span
                    className={
                      cartQuantity < 10 ? "cart-item-no small-cart cart-mobile" : "cart-item-no large-cart cart-mobile"
                    }
                    style={{ color: "rgb(255, 0, 0)" }}
                  >
                    {cartQuantity}
                  </span>{" "}
                  <img src="/Images/ShoppingCartSimple.svg" className="cart cart-img-mobile" alt="Cart" />
                </Nav.Link>
              ) : null}
          ...
          <Navbar.Collapse id="navbar-nav" className="justify-content-between">
            <Nav className="me-auto mx-auto">
              ...
              {/* Wishlist */}
              <Nav.Link href="/Wishlist" active={location.pathname === "/Wishlist"}>
                <svg
                  width="26"
                  height="27"
                  viewBox="0 0 26 27"
